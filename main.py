...
async def mod_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "mod_bala":
        ...
        keyboard = [
            [
                InlineKeyboardButton("🔴 1H (₹35)", callback_data="buy_bala_1h", style="danger"),
                InlineKeyboardButton("🔴 3H (₹80)", callback_data="buy_bala_3h", style="danger"),
            ],
            [
                InlineKeyboardButton("🔴 6H (₹140)", callback_data="buy_bala_6h", style="danger"),
                InlineKeyboardButton("🔴 12H (₹240)", callback_data="buy_bala_12h", style="danger"),
            ],
            [InlineKeyboardButton("🔴 24H (₹380)", callback_data="buy_bala_24h", style="danger")],
            [
                InlineKeyboardButton("🔴 2D (₹650)", callback_data="buy_bala_2d", style="danger"),
                InlineKeyboardButton("🔴 3D (₹800)", callback_data="buy_bala_3d", style="danger"),
            ],
            [
                InlineKeyboardButton("🔙 Back", callback_data="show_demos", style="primary"),
                InlineKeyboardButton("🏠 Main Menu", callback_data="main_menu", style="primary"),
            ],
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
        ...
        keyboard = [
            [
                InlineKeyboardButton(
                    "🔵 Purchase 10-Day Key - ₹500", callback_data="buy_ninex_10d", style="primary"
                )
            ],
            [
                InlineKeyboardButton("🔙 Back", callback_data="show_demos", style="primary"),
