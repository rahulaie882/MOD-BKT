...
# ---------- CASHFREE (YAHAN APNI KEYS DALO) ----------
CASHFREE_APP_ID = "YAHAN_APP_ID_DALO"          # ← Cashfree App ID
CASHFREE_SECRET_KEY = "YAHAN_SECRET_KEY_DALO"  # ← Cashfree Secret Key
CASHFREE_ENV = "PROD"  # "PROD" = Live, "TEST" = Sandbox
# -----------------------------------------------------
